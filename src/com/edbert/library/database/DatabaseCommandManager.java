 ...
 * Primarily, this is core operations that require us to know the database itself.
 */
...
public class DatabaseCommandManager {
	...
	private static DatabaseCommandManager instance;

	public static DatabaseCommandManager getInstance(Context c, String authority) {
		if (instance == null)
			instance = new DatabaseCommandManager(c, authority);
	...
	public DatabaseCommandManager(Context context, String authority) {
